...
export default function BookingResult({ product, vat, qty, onChangeQty, onSubmit, date, period, loading }) {
            ...
            <div className=''>
                <div className='grid grid-cols-5'>
                    ...
                    <div className='col-span-3 px-2'>
                        <p className='text-sm'>{product?.fullname} {product?.place?.templeName} {product?.place?.province?.data?.attributes?.name}</p>
                        <p className='text-[10px] text-gray-400 mb-2'>วันที่ {dateText} ({t(period)})</p>
                ...
                <p className='mb-2 font-medium'>จำนวนขอพร-แก้บนที่ต้องการ</p>
                <div className='grid grid-cols-5'>
